...
with con:
    ...
    for row in HouseNumbers:
        ...
        (IntervalID, HouseID, Appliance,Data,Year, Month, Day, Hour, Minute, DayOfTheWeek)\
        ...
        for line in dist:
          ...
          Day = %s and Hour = %s and Minute = %s and IntervalID = 1" % (HouseNumber2, yr, mth, dy, hr, mins)
          ...
          Select id, Data, Appliance from %s where Year = %s and Month = %s and  \
          Day = %s and Hour = %s and Minute = %s and IntervalID = 2" % (HouseNumber2, yr, mth, dy, hr, mins)
          ...
          Select id, Data, Appliance from %s where Year = %s and Month = %s and  \
          Day = %s and Hour = %s and Minute = %s and IntervalID = 3" % (HouseNumber2, yr, mth, dy, hr, mins)
          ...
          % (HouseNumber1, total_sum, HouseNumber2, yr, mth, dy, hr, mins)
