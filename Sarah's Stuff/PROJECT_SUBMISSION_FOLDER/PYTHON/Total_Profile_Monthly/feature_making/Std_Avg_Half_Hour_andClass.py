...
with con:
    ...
    arff.dump('StdvAvg_HALF_HourAndClass.arff',data5, relation='StdAvg_HALF_HourAndClass', names = column_names)



    out = csv.writer(open("StdvAvg_HALF_HourAndClass.csv","w"), delimiter = ',')
