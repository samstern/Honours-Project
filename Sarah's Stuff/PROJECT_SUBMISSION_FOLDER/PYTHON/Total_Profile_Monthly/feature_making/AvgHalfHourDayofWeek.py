...
with con:
    ...
    print arff.dump('Binary_Avg_HALF_HourDayOfWeekAndClass.arff',data4, relation='Binary_Avg_HALF_HourDayOfWeekAndClass', names = NumDayClass)

    out = csv.writer(open("Binary_Avg_HALF_HourDayOfWeekAndClass.csv","w"), delimiter = ',')
