...
with con:
    ...
    print arff.dump('BINARY_TotalProfile_StdAvgDayOfWeekAndClass.arff',data5, relation='BINARY_TotalProfile_StdAvgDayOfWeekAndClass', names = ['amonday','atuesday', \
    ...
    out = csv.writer(open("BINARY_TotalProfile_StdAvgDayOfWeekAndClass.csv","w"), delimiter = ',')
