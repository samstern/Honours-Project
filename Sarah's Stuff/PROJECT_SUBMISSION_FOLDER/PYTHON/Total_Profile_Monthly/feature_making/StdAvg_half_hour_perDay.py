...
with con:
    ...
    print arff.dump('StdvAvg_HALF_HourDayOfWeekAndClass.arff',data5, relation='StvAvg_HALF_HourDayOfWeekAndClass', names = NumDayClass)



    column_names = NumDayClass
    out = csv.writer(open("StdvAvg_HALF_HourDayOfWeekAndClass.csv","w"), delimiter = ',')
