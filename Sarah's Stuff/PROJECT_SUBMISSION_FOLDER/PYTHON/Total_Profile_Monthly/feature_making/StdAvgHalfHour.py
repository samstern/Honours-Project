...
with con:
    ...
    print arff.dump('STD_Average_Half_Hour_Monthly.arff',data, relation='STD_Average_Half_Hour_Monthly', names = column_names)

    out = csv.writer(open("STD_Average_Half_Hour_Monthly.csv","w"), delimiter = ',')
