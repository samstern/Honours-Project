...
with con:
    ...
    out = csv.writer(open("Avg_HALF_HourAndClass.csv","w"), delimiter = ',')
    ...
    """print arff.dump('TotalProfile_Avg_HALF_HourAndClass.arff',data4, relation='TotalProfile_Avg_HALF_HourAndClass', names = ['0', \
