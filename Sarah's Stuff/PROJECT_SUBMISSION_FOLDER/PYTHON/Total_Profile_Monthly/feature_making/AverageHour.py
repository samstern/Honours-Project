...
with con:
    ...
    print arff.dump('Average_Hour_Monthly.arff',data, relation='Average_Hour_Monthly', names = column_names)

    out = csv.writer(open("Average_Hour_Monthly.csv","w"), delimiter = ',')
