...
with con:
    ...
    print arff.dump('BINARY_Average_Day_Monthly.arff',data, relation='BINARY_Average_Day_Monthly', names = column_names)

    out = csv.writer(open("BINARY_Average_Day_Monthly.csv","w"), delimiter = ',')
