...
with con:
    ...
    print arff.dump('BINARY_STD_Average_Hour_Monthly.arff',data, relation='BINARY_STD_Average_Hour_Monthly', names = column_names)

    out = csv.writer(open("BINARY_STD_Average_Hour_Monthly.csv","w"), delimiter = ',')
