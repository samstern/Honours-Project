...
with con:
    ...
    out = csv.writer(open("BINARY_AvgHourAndClass.csv","w"), delimiter = ',')
    ...
    print arff.dump('BINARY_TotalProfile_AvgHourAndClass.arff',data4, relation='BINARY_TotalProfile_AvgHourAndClass', names = ['00','01','02','03',\
