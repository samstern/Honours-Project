...
with con:
    ...
    arff.dump('BINARY_TotalProfile_StdvAvgHourAndClass.arff',data5, relation='BINARY_TotalProfile_StdAvgHourAndClass', names = ['a00','a01','a02','a03',\
    ...
    out = csv.writer(open("BINARY_TotalProfile_StdvAvgHourAndClass.csv","w"), delimiter = ',')
