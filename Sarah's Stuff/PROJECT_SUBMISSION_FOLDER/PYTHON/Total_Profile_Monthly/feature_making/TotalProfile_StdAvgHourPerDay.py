...
with con:
    ...
    print arff.dump('BINARY_TotalProfile_StdvAvgHourDayOfWeekAndClass.arff',data5, relation='BINARY_TotalProfile_StvAvgHourDayOfWeekAndClass', names = NumDayClass)



    column_names = NumDayClass
    out = csv.writer(open("BINARY_TotalProfile_StdvAvgHourDayOfWeekAndClass.csv","w"), delimiter = ',')
