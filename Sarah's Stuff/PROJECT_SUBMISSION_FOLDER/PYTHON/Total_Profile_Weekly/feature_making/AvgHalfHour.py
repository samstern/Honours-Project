...
with con:
    ...
    print arff.dump('BINARY_Average_Half_Hour_Weekly.arff',data, relation='BINARY_Average_Half_Hour_Weekly', names = column_names)

    out = csv.writer(open("BINARY_Average_Half_Hour_Weekly.csv","w"), delimiter = ',')
