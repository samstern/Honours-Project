...
with con:
    ...
    for TN in all_tables:
        ...
        result = AvgPerHalfHourDay(cur,'temp', TN)
        day = []
        hour = []
        avg = []
    ...
    print arff.dump('BINARY_Weekly_Avg_HALF_HourDayOfWeekAndClass.arff',data4, relation='BINARY_Weekly_Avg_HALF_HourDayOfWeekAndClass', names = NumDayClass)

    out = csv.writer(open("BINARY_Weekly_Avg_HALF_HourDayOfWeekAndClass.csv","w"), delimiter = ',')
