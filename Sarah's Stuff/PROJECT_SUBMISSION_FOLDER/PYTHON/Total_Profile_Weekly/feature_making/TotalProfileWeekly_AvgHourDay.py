...
with con:
    ...
    print arff.dump('TotalProfileWeekly_AvgHourDayOfWeekAndClass.arff',data4, relation='TotalProfileWeekly_AvgHourDayOfWeekAndClass', names = NumDayClass)


    out = csv.writer(open("WeeklyAvgHourDayAndClass.csv","w"), delimiter = ',')
