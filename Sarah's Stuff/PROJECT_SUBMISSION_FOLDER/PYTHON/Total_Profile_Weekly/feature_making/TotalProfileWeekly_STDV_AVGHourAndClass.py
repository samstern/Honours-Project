...
with con:
    ...
    arff.dump('TotalProfileWeekly_StdvAvgHourAndClass.arff',data5, relation='TotalProfile_StdAvgHourAndClass', names = ['a00','a01','a02','a03',\
    ...
    out = csv.writer(open("WeeklyStdAvgHourAndClass.csv","w"), delimiter = ',')
