...
with con:
    ...
    column_names = ['AverageHalfHour','StdHalfHour','Occupancy']

    print arff.dump('BINARY_STD_Average_Half_Hour_Weekly.arff',data, relation='BINARY_STD_Average_Half_Hour_Weekly', names = column_names)

    out = csv.writer(open("BINARY_STD_Average_Half_Hour_Weekly.csv","w"), delimiter = ',')
