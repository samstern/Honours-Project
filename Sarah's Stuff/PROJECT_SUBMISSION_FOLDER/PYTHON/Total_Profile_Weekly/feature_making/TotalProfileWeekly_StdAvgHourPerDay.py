...
with con:
    ...
    print arff.dump('TotalProfileWeekly_StdvAvgHourDayOfWeekAndClass.arff',data5, relation='TotalProfileWeekly_StvAvgHourDayOfWeekAndClass', names = NumDayClass)

    out = csv.writer(open("WeeklyStdAvgHourPerDayAndClass.csv","w"), delimiter = ',')
    out.writerow(NumDayClass)
