function [data] = import4WeekData(dbConn)
...
curs = exec(conn, sprintf('select f.*, c.occupancy,c.children,c.social_grade from Four_Weeks.%s f, hes_database.classes c where f.houseid = c.household',table));
