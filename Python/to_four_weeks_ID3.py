...
with con:
    ...
    #use the mode start date from the ID1 households
    #tablesID1 = GetInfoId1(cur)
    startDay = 1#getStartDay(cur, tablesID1)
    ...
    for table in tables3:
        ...
        i=1
        getRemainingDays="SELECT COUNT(DISTINCT date) FROM Ten_Mins.%s WHERE DATE >(%s)" %(Table_Name,selectStartDay)
